...
@IBDesignable
class ForestOfTheHanged: UIView {
    ...
    private func drawHead() {
        ...
        let path = UIBezierPath(arcCenter: CGPoint(x: self.frame.width/2 + 25, y: self.frame.height/2 - 80), radius: 20, startAngle: 0.0, endAngle: CGFloat(2 * M_PI), clockwise: true)
